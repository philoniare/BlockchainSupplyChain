...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        const tx = await supplyChain.buyItem(upc, {from: distributorID, value: productPrice * 2});
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        assert.equal(resultBufferTwo[7], retailerID, 'Error: Invalid distributor')
    })    
    ...
    it("Testing smart contract function fetchItemBufferOne() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert.equal(resultBufferOne[2], consumerID, 'Error: Invalid owner')
        assert.equal(resultBufferOne[3], originFarmerID, 'Error: Invalid farm id')
        ...
        assert.equal(resultBufferOne[6], originFarmLatitude, 'Error: Invalid farm lat')
        assert.equal(resultBufferOne[7], originFarmLongitude, 'Error: Invalid farm lon')
    })
